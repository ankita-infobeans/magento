...
AdminOrder.prototype = {
    ...
    productConfigureSubmit : function(listType, area, fieldsPrepare, itemsFilter) {
        ...
        /*update ajax change by abhilash*/
        if(JSON.stringify(listType) == '"quote_items"'){//'sidebar,items,shipping_method,billing_method,totals,giftmessage,message'){
             location.reload();
        }
         /*update ajax change by abhilash end*/
        }.bind(this));
