...
class ICC_Volumelicense_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @param int $Totaluser
     */
    public function volumeLicenseShareEmail($email_to,$mailData){
     ...
     * @param int $registred
     */
     public function volumeLicenseNotifyEmail($email_to,$customername,$productname,$cteatedDate,$Totaluser,$registred){
    ...
    public function setReportsLog ($order = null, $reassign = false){
