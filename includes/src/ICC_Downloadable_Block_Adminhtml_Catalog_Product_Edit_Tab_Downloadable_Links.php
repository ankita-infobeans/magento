 ...
 */
class ICC_Downloadable_Block_Adminhtml_Catalog_Product_Edit_Tab_Downloadable_Links
    extends Mage_Downloadable_Block_Adminhtml_Catalog_Product_Edit_Tab_Downloadable_Links
{
    ...
    public function getLinkData()
    {
        ...
        foreach ($links as $item) {
            $tmpLinkItem = array(
                ...
                'number_of_purchases' => $item->getNumberOfPurchases(),
    ...
    public function getConfigJson($type='links')
    {
        $this->getConfig()->setUrl(Mage::getModel('adminhtml/url')->addSessionParam()
            ->getUrl('*/downloadable_fileOverwrite/upload', array('type' => $type, '_secure' => true)));
