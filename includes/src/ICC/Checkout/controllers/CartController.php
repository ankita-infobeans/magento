...
class ICC_Checkout_CartController extends Mage_Checkout_CartController
{
    /**
    ...
    public function couponPostAction()
    {
        ...
        try {
			...
			// quick country fix
            if($this->_getQuote()->getShippingAddress()->getCountryId() == null) {
              $this->_getQuote()->getShippingAddress()->setCountryId('US');
            }
