<?php
class ICC_Premiumaccess_Block_Adminhtml_Assign_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_updateButton("save", "label", Mage::helper("icc_premiumaccess")->__("Save Item"));
        $this->_addButton("saveandcontinue", array(
            "label" => Mage::helper("icc_premiumaccess")->__("Save And Continue Edit"),
    ...
    public function getHeaderText() {
        if (Mage::registry("assign_data") && Mage::registry("assign_data")->getId()) {
            ...
            return Mage::helper("icc_premiumaccess")->__("Reassign Order#: %s", $this->htmlEscape(Mage::registry("assign_data")->getIncrementId()));
        } else {
