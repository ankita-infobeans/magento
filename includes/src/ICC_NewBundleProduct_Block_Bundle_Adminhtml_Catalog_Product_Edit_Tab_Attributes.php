 ...
 *
 * @category    ICC
 * @package     ICC_GroupConfigurable
 */
class ICC_NewBundleProduct_Block_Bundle_Adminhtml_Catalog_Product_Edit_Tab_Attributes
        ...
        if ($tier_price) {
            $tier_price->setRenderer(
                $this->getLayout()->createBlock('adminhtml/catalog_product_edit_tab_price_tier')
                    ->setPriceColumnHeader(Mage::helper('bundle')->__('Price')) // Change Price Discount to Price
