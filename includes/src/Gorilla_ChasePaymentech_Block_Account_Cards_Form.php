<?php
class Gorilla_ChasePaymentech_Block_Account_Cards_Form extends Mage_Customer_Block_Account_Dashboard
{
    public function getMethodCode()
    {
        return Mage::getSingleton('chasepaymentech/gateway')->getCode();
    }

    public function isSaveOptional()
    {
        return Mage::getStoreConfig('chasepaymentech/save_optional');
    }

    public function hasVerification()
    {
        return true;
        return Mage::getModel('chasepaymentech/gateway')->getConfigData('cctypes');
    }
    ...
    public function getCcAvailableTypes()
    {
        ...
        $availableTypes = explode(',',Mage::getModel('chasepaymentech/gateway')->getConfigData('cctypes'));
        if ($availableTypes) {
